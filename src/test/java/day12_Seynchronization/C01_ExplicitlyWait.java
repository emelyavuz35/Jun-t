...
public class C01_ExplicitlyWait extends TestBase {
        ...
        public void explicitlywaitTesti() {
            ...
            yazının gorunur olmasını beklerken yazının locate ını kullanmak sorun olustururu
            cunku henuz gorunmeyen bır yazının locate edılmesıde mumkun olmayabılır
            (html kodları yazan developer farklı uygulamalar yapabılır.bu)
            durumda bekleme ıslemı ve locate ı bırlıkte yapmalıyız
             */
